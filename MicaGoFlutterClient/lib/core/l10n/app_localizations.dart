...
const _strings = {
  ...
  'zhHans': {
    ...
    'pair.cameraHelp': 'micaGO 需要相机权限来扫描配对码。请在 Android 设置中授予相机权限后返回，再点击"重试相机"。你也可以手动配对。',
  ...
  'zhHant': {
    ...
    'pair.cameraHelp': 'micaGO 需要相機權限來掃描配對碼。請在 Android 設定中授予相機權限後返回，再點擊「重試相機」。你也可以手動配對。',
