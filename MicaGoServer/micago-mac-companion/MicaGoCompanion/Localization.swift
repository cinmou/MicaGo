...
enum L10n {
    ...
    private static let en = [
        ...
        "sync.desc": "Choose which conversations are saved to the relay and which send push notifications. This is a privacy/management view, not a chat client. Blocking a chat stops future sync; messages already synced are kept.",
        ...
        "sync.recentMessages": "Recent Messages",
        "sync.chats": "Chats",
    ...
    private static let zhHans = [
        ...
        "sync.title": "同步控制",
        "sync.desc": "选择哪些会话保存到中继，以及哪些发送推送通知。这是一个隐私/管理视图，而非聊天客户端。屏蔽某个会话会停止其今后的同步；已同步的消息会保留。",
    ...
    private static let zhHant = [
        ...
        "sync.title": "同步控制",
        "sync.desc": "選擇哪些對話儲存到中繼，以及哪些傳送推播通知。這是一個隱私/管理檢視，而非聊天用戶端。封鎖某個對話會停止其今後的同步；已同步的訊息會保留。",
